...
class Ui_winMain(QtGui.QWidget):
    def __init__(self):
        ...
        self.btnGenerateHash.setGeometry(QtCore.QRect(10, 330, 281, 21))
        self.btnGenerateHash.setObjectName(_fromUtf8("btnGenerateHash"))
        self.btnSolveEquation = QtGui.QPushButton(self.gbxTools)
        self.btnSolveEquation.setGeometry(QtCore.QRect(10, 360, 281, 21))
    ...
    def retranslateUi(self, winMain):
        ...
        def equation_action():
            ...
            try:
                ...
                output = "Numbers need to be enter..."
